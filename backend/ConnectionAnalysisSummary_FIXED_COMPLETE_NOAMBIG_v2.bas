...
'Private 
Function CASW_GetDasaWindowCachedFromRange( _
    ...
    CASW_GetDasaWindowCachedFromRange = CAS_GetDasaWindow_Internal(LevelsConnected, md, ad, pd, su, prana, deh)
End Function
...
' --- Duplicate CASW_GetDasaWindowCachedFromRange removed to avoid ambiguous name ---
